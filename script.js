...
//   1. Create a folder called "images" next to your 3 files
//   2. Copy your photos into that folder
//   3. Update the "image" value below to match your filename
//      e.g.  image: 'images/classic-box.jpg'
//   4. Save script.js — photo appears instantly in the browser
//   NOTE: After changing these defaults, open the site, go to
//   Admin > Products and click "Reset to defaults" OR clear your
//   browser localStorage once so the new paths are picked up.
// ----------------------------------------------------------------
const DEFAULT_PRODUCTS = [
  {
    ...
    price: 2800,
    category: 'medium',
    // ▼ Replace with your actual filename, e.g. 'images/classic-box.jpg'
  ...
  },
  {
    ...
    price: 3800,
    category: 'large',
    // ▼ Replace with your actual filename, e.g. 'images/explorer-large.jpg'
  ...
  },
  {
    ...
    price: 1800,
    category: 'small',
    // ▼ Replace with your actual filename, e.g. 'images/mini-wanderer.jpg'
  ...
  },
  {
    ...
    price: 6500,
    category: 'gift',
    // ▼ Replace with your actual filename, e.g. 'images/gift-set.jpg'
  ...
  },
  {
    ...
    price: 3500,
    category: 'medium',
    // ▼ Replace with your actual filename, e.g. 'images/engraved-edition.jpg'
  ...
  },
  {
    ...
    price: 2200,
    category: 'small',
    // ▼ Replace with your actual filename, e.g. 'images/daily-carry.jpg'
...
function resetProductsToDefaults() {
  if (!confirm('This will reload all products from your script.js code — any admin edits will be replaced. Continue?')) return;
  localStorage.removeItem('sp_products');
  products = JSON.parse(JSON.stringify(DEFAULT_PRODUCTS)); // deep copy
  saveProducts();
  renderAdminProducts();
  renderShopGrid();
  renderFeaturedProducts();
  showToast('Products reloaded from code ✓', 'success');
}
